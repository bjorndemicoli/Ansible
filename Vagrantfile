...
#    config.vm.define "kbn01" do |kbn01|
#        kbn01.vm.box = "bento/centos-7.4"
#        kbn01.vm.hostname = "kbn01"
#        kbn01.vm.network "private_network" , ip: "172.28.128.22"
#        kbn01.vm.provider "vmware_desktop" do |v|
#            v.cpus = 1
#            v.memory = 1024
#        end
#    end
